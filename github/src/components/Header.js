    ...
    <header className="bg-black p-4 flex-shrink-0">
      <nav className="flex items-center justify-between">
        ...
        <ul className="flex space-x-5 md:space-x-7 text-white text-medium sm:text-lg md:text-xl font-medium font-serif cursor-pointer">
          ...
          <li>
            <a
              href="https://github.com/TarannumAfreen"
              target="_blank"
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/tarannum-afreen-dev"
              target="_blank"
              rel="noopener noreferrer"
            >
              LinkedIn
          ...
          <li>
            <a href="mailto:tarannumafren@gmail.com">Mail</a>
          </li>
        </ul>
      </nav>
      <div className="text-center mt-10 sm:mt-20 flex flex-col items-center justify-center w-full">
        <img
          src={github}
          alt="GitHub Logo"
          className="h-16 sm:h-20 md:h-24 rounded-full mb-4 sm:mb-6 md:mb-8"
        />
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold font-serif text-green-300">
          Tarannum Afreen
        </h1>
